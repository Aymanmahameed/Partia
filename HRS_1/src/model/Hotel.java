...
public class Hotel implements Serializable {
    ...
    public void writeser() throws IOException{
    	try {
			FileOutputStream fileOutputStream = new FileOutputStream("Hotel.ser");
			ObjectOutputStream objectOutputStream = new ObjectOutputStream(fileOutputStream);
			
			objectOutputStream.writeObject(Hotel.getInstance());
     ...
     public void readser() {
    	try (FileInputStream fileInputStream = new FileInputStream("Hotel.ser");
				ObjectInputStream objectInputStream = new ObjectInputStream(fileInputStream)) {

			try {
				while (true) {
					
					Hotel h = ((Hotel) objectInputStream.readObject());
					this.setAllBookings(h.getAllBookings());
					this.setAllDepartments(h.getAllDepartments());
					this.setAllCustomers(h.getAllCustomers());
					this.setAllEmployees(h.getAllEmployees());
					this.setAllRooms(h.getAllRooms());
