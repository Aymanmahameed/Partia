...
public class GetRealSupRoom {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GetRealSupRoom window = new GetRealSupRoom();
	...
	private void initialize() {
		...
		EnterLabel = new JLabel("Please provide the ID of the superior room you're seeking:");
		...
		IDtxtF.setText("SuperiorRoom");
        
        JButton EnterBtn = new JButton("enter");
        EnterBtn.setBackground(Color.WHITE);
        EnterBtn.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		Room m = Hotel.getInstance().getRealSuperiorRoom(IDtxtF.getText());
				if (m != null) {
					if (m instanceof SuperiorRoom ) {
						...
						Boolean flag = ((SuperiorRoom)m).isHasView();
						if(flag) {
							ViewTxt.setText("has");
						}
						else
							ViewTxt.setText("hasn`t");
						Boolean flag2 = ((SuperiorRoom)m).isHasJaccozi();
						if(flag2) {
						...
						JOptionPane.showMessageDialog(frame, "The Room is not a Superior Room");
					}
        ...
        lblMaximum.setFont(new Font("Tahoma", Font.PLAIN, 16));
        ...
        ViewLabel1.setFont(new Font("Tahoma", Font.PLAIN, 16));
        ...
        ViewLabel2.setFont(new Font("Tahoma", Font.PLAIN, 16));
