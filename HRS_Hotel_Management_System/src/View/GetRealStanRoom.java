...
public class GetRealStanRoom {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GetRealStanRoom window = new GetRealStanRoom();
	...
	private void initialize() {
		...
		EnterLabel = new JLabel("Please provide the ID of the standard room you're seeking:");
		...
		IDtxtF.setText("StandardRoom");

		JButton EnterBtn = new JButton("enter");
		EnterBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Room m = Hotel.getInstance().getRealStandardRoom(IDtxtF.getText());
				if (m != null) {
					if (m instanceof StandardRoom) {
						...
						Boolean flag = ((StandardRoom)m).isHasView();
						if(flag) {
							ViewTxt.setText("has");
						}
						else
						...
						JOptionPane.showMessageDialog(frame, "The Room is not a standard Room");
					}
